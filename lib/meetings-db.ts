...
export async function getMeetings(
  ...
  // Cast, not validated at runtime — acceptable for this assignment's scope;
  // a schema migration that renames/drops a column would fail silently here.
...
export async function updateMeeting(
  ...
  const rows = await sql`
    UPDATE meetings SET
      ...
      announcements   = ${JSON.stringify(data.announcements ?? [])}::jsonb,
